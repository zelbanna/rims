...
def list(aWeb):
 ...
 for row in res['data']:
  aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>%s</DIV><DIV CLASS=td STYLE='max-width:180px; overflow-x:hidden'>%s</DIV><DIV CLASS=td STYLE='max-width:20px'>"%(row['id'],row['name']))
...
def info(aWeb):
 ...
 aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>Name:</DIV><DIV CLASS=td><INPUT TYPE=TEXT NAME=name VALUE='%s'></DIV></DIV>"%info['name'])
 aWeb.wr("</DIV></DIV>")
