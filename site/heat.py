...
def list(aWeb):
 ...
 print aWeb.button('reload',DIV='div_content',URL='zdcp.cgi?heat_list')
 print aWeb.button('add',   DIV='div_content_right',URL='zdcp.cgi?heat_choose_template')
 print "</DIV>"
 ...
 for stack in data.get('stacks'):
  ...
  print aWeb.button('info',DIV='div_content_right', SPIN='true', URL='zdcp.cgi?heat_action&name=%s&id=%s&op=info'%(stack['stack_name'],stack['id']))
  if stack['stack_status'] == "CREATE_COMPLETE" or stack['stack_status'] == "CREATE_FAILED" or stack['stack_status'] == "DELETE_FAILED":
   print aWeb.button('delete', DIV='div_content_right', SPIN='true', URL='zdcp.cgi?heat_action&name=%s&id=%s&op=remove'%(stack['stack_name'],stack['id']), MSG='Are you sure?')
  print "</DIV></DIV></DIV>"
 print "</DIV></DIV>"
...
def enter_parameters(aWeb):
 ...
 print "</DIV></DIV>"
 print "</FORM><DIV CLASS=controls>"
 print aWeb.button('forward',DIV='div_content_right', URL='zdcp.cgi?heat_action&op=create',FRM='frm_heat_template_parameters', SPIN='true')
 print "</DIV>"
...
def add_template(aWeb):
 ...
 print "</DIV></DIV>"
 print "</FORM><DIV CLASS=controls>"
 print aWeb.button('start',DIV='div_content_right', URL='zdcp.cgi?heat_action&op=add_template',FRM='frm_heat_template_parameters', SPIN='true')
 print "</DIV>"
#
# Heat Actions
#
