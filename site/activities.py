...
def main(aWeb):
 ...
 print "<NAV><UL>"
 print "<LI><A CLASS=z-op DIV=div_content URL='zdcp.cgi?activities_list'>Activities</A></LI>"
 print "<LI><A CLASS=z-op DIV=div_content URL='zdcp.cgi?activities_report'>Report</A></LI>"
 print "</UL></NAV>"
...
def list(aWeb):
 ...
 print aWeb.button('reload', DIV='div_content', URL='zdcp.cgi?activities_list')
 print aWeb.button('add',    DIV='div_content_right',URL='zdcp.cgi?activities_info&id=new')
 print aWeb.button('info',   DIV='div_content',URL='zdcp.cgi?activities_type_list')
 ...
 for row in rows:
  ...
  print aWeb.button('info',   DIV='div_content_right', URL='zdcp.cgi?activities_info&id=%s'%row['id'])
  print aWeb.button('delete', DIV='div_content_right', URL='zdcp.cgi?activities_delete&id=%s'%row['id'])
  print "</DIV></DIV></DIV>"
...
def info(aWeb):
 ...
 if data['id'] != 'new':
  print aWeb.button('delete',DIV='div_content_right',URL='zdcp.cgi?activities_delete&id={0}'.format(data['id']), MSG='Really remove activity?')
 print aWeb.button('save',DIV='div_content_right', URL='zdcp.cgi?activities_info&op=update', FRM='activity_form')
 print "</DIV></ARTICLE>"
...
def type_list(aWeb):
 ...
 print aWeb.button('reload', DIV='div_content', URL='zdcp.cgi?activities_type_list')
 print aWeb.button('add',    DIV='div_content_right',URL='zdcp.cgi?activities_type_info&id=new')
 ...
 for row in rows:
  ...
  print aWeb.button('info',   DIV='div_content_right', URL='zdcp.cgi?activities_type_info&id=%s'%row['id'])
  print aWeb.button('delete', DIV='div_content_right', URL='zdcp.cgi?activities_type_delete&id=%s'%row['id'])
  print "</DIV></DIV></DIV>"
 print "</DIV></DIV></ARTICLE></SECTION>"
 print "<SECTION CLASS=content-right ID=div_content_right></SECTION>"
...
def type_info(aWeb):
 ...
 print "</FORM><DIV CLASS=controls>"
 if data['id'] != 'new':
  print aWeb.button('delete',DIV='div_content_right',URL='zdcp.cgi?activities_type_delete&id={0}'.format(data['id']), MSG='Really remove activity?')
 print aWeb.button('save',DIV='div_content_right', URL='zdcp.cgi?activities_type_info&op=update', FRM='activity_form')
 print "</DIV></ARTICLE>"
