...
def manage(aWeb):
 ...
 for row in data['inventories']:
  aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>%s</DIV><DIV CLASS='td maxed'>%s</DIV><DIV CLASS=td><DIV CLASS=controls>"%(row['id'],row['name']))
...
def inventory(aWeb):
 ...
 aWeb.wr("<ARTICLE><P>Hosts</P><DIV CLASS=controls>")
 ...
 aWeb.wr("</DIV><SPAN CLASS=results>%s</SPAN><FORM ID=host_list>"%(opres))
 ...
 for row in res['hosts']:
  ...
  aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>%s</DIV><DIV CLASS=td>%s</DIV><DIV CLASS=td>%s</DIV><DIV CLASS=td>%s</DIV><DIV CLASS=td><DIV CLASS=controls>"%(row['id'],name,row['description'],",".join([k['name'] for k in row['groups']])))
...
def inventory_device_choose(aWeb):
 ...
 for row in res['data']:
  aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>%(id)s</DIV><DIV CLASS=td>%(hostname)s.%(domain)s</DIV><DIV CLASS=td><DIV CLASS=controls><INPUT TYPE=CHECKBOX VALUE=%(id)s NAME=device_%(id)s></DIV></DIV></DIV>"%row)
...
def inventory_device_sync(aWeb):
 ...
 aWeb.wr("<ARTICLE><P>Synced Devices</P><DIV CLASS=controls>")
