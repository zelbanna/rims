...
def list(aWeb):
 ...
 print aWeb.button('reload', DIV='div_content', URL='sdcp.cgi?appformix_list')
 print "</DIV>"
 ...
 for rep in res['reports']:
  ...
  print "<DIV CLASS=td>"
  print aWeb.button('info', DIV='div_content_right', URL='sdcp.cgi?appformix_info&report=%s'%(rep['ReportId']))
  print "</DIV></DIV>"
 print "</DIV></DIV>"
