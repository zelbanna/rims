...
def info(aWeb):
 ...
 aWeb.wr("<DIV>User:</DIV><DIV>%s</DIV>"%(data['alias']))
 aWeb.wr("<DIV>Start:</DIV><DIV>%s</DIV>"%(data['start']))
 aWeb.wr("<DIV>End:</DIV><DIV>%s</DIV>"%(data['end']))
 aWeb.wr("<DIV TITLE='Indicate shutdown on expiration'>Shutdown:</DIV><DIV>")
 ...
 aWeb.wr("</DIV>")
 aWeb.wr("<DIV>Info:</DIV><DIV><INPUT TYPE=TEXT NAME=info  STYLE='min-width:200px;' VALUE='%s'></DIV>"%(data['info']))
 aWeb.wr("</DIV>")
 aWeb.wr("</FORM>")
