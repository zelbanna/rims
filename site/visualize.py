...
def network(aWeb):
 ...
 aWeb.wr("<LABEL FOR=name>Name:</LABEL><FORM ID='visualize_network'><INPUT TYPE=TEXT CLASS=background STYLE='width:120px' VALUE='%s' NAME=name><SPAN ID=result CLASS=results>%s</SPAN>"%(res['name'],res.get('status',"")))
