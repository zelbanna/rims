...
def remove(aWeb):
 ...
 db = DB()
 db.connect()
 db.do("UPDATE devices SET pem0_pdu_unit = 0, pem0_pdu_slot = 0 WHERE id = '{0}'".format(id))
 db.do("UPDATE devices SET pem1_pdu_unit = 0, pem1_pdu_slot = 0 WHERE id = '{0}'".format(id))
