...
def list(aWeb):
 ...
 aWeb.wr(aWeb.button('reload', DIV='div_content_left',  URL='location_list?%s'%aWeb.get_args(), TITLE='Reload'))
 aWeb.wr(aWeb.button('add',    DIV='div_content_right', URL='location_info?id=new', TITLE='Add to locations'))
 ...
 for row in res['data']:
  ...
  aWeb.wr(aWeb.button('edit', DIV='div_content_right', URL='location_info?id=%s'%row['id']))
  aWeb.wr(aWeb.button('trash',DIV='div_content_right', URL='location_delete?id=%s'%row['id'], MSG='Really remove item?'))
  aWeb.wr("</DIV></DIV>")
...
def info(aWeb):
 ...
 aWeb.wr("</DIV>")
 aWeb.wr(aWeb.button('reload',DIV='div_content_right', URL='location_info?id=%s'%info['id']))
 if info['id'] != 'new':
  aWeb.wr(aWeb.button('delete',DIV='div_content_right',URL='location_delete?id=%s'%info['id'], MSG='Really remove item?'))
 aWeb.wr(aWeb.button('save',DIV='div_content_right', URL='location_info?op=update', FRM='location_info_form'))
 aWeb.wr("</ARTICLE>")
