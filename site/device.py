...
def main(aWeb):
 ...
 aWeb.wr("<A CLASS=z-op DIV=div_content      URL='system_server_list?type=DHCP'>Servers</A>")
 ...
 aWeb.wr("<A CLASS=z-op DIV=div_content      URL='system_server_list?type=DNS'>Servers</A>")
