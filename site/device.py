...
def info(aWeb):
 ...
 aWeb.wr("<DIV CLASS=tr><DIV CLASS=td>Device ID:</DIV><DIV CLASS='td readonly'>%s</DIV></DIV>"%dev['id'])
 ...
 aWeb.wr(aWeb.button('search',     DIV='div_content_right',URL='device_info?op=lookup', FRM='info_form', TITLE='Lookup and Detect Device information'))
