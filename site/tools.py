...
def list(aWeb):
 ...
 print "<DIV CLASS=tr><DIV CLASS=td><A CLASS=z-op DIV=div_content_right           URL='sdcp.cgi?call=tools_error'>Test Errors</A></DIV></DIV>"
...
def error(aWeb):
 ...
 res = rest_call(PC.dns['url'],'sdcp.rest.hej')
 print res
