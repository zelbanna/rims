...
def info(aWeb):
 ...
 aWeb.wr("<DIV>Node:</DIV><DIV><INPUT   TYPE=TEXT NAME=node STYLE='min-width:200px;' VALUE='%s'></DIV>"%(data['node']))
 aWeb.wr("<DIV>URL:</DIV><DIV><INPUT    TYPE=URL  NAME=url  STYLE='min-width:200px;' VALUE='%s'></DIV>"%(data['url']))
 aWeb.wr("<DIV>Device:</DIV><DIV><INPUT TYPE=TEXT NAME=hostname STYLE='min-width:200px;' VALUE='%s'></DIV>"%(data['hostname']))
 aWeb.wr("</DIV>")
 aWeb.wr("</FORM>")
