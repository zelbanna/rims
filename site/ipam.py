...
def network_info(aWeb):
 ...
 aWeb.wr("<DIV>ID:</DIV><DIV>%(id)s</DIV>"%data)
 aWeb.wr("<DIV>Description:</DIV><DIV><INPUT TYPE=TEXT NAME=description VALUE='{}'></DIV>".format(data['description']))
 aWeb.wr("<DIV>Network:</DIV><DIV><INPUT TYPE=TEXT NAME=network  VALUE='{}' '{}'></DIV>".format(data['network'],lock))
 aWeb.wr("<DIV>Mask:</DIV><DIV><INPUT    TYPE=TEXT NAME=mask    VALUE='{}' '{}'></DIV>".format(data['mask'],lock))
 aWeb.wr("<DIV>Gateway:</DIV><DIV><INPUT TYPE=TEXT NAME=gateway VALUE='{}'></DIV>".format(data['gateway']))
 ...
 aWeb.wr("</SELECT></DIV>")
 aWeb.wr("<DIV>Reverse Zone:</DIV><DIV><SELECT NAME=reverse_zone_id>")
...
def address_info(aWeb):
 ...
 aWeb.wr("<DIV CLASS='info col2'>")
 aWeb.wr("<DIV>ID:</DIV><DIV>%s</DIV>"%(data['data']['id']))
 aWeb.wr("<DIV>State:</DIV><DIV><DIV CLASS='state %s' /></DIV>"%(aWeb.state_ascii(data['data']['state'])))
 aWeb.wr("<DIV>Network:</DIV><DIV>%s</DIV>"%(data['extra']['network']))
 aWeb.wr("<DIV>IP:</DIV><DIV><INPUT       TYPE=TEXT NAME=ip       VALUE='%s'></DIV>"%(data['data']['ip']))
 aWeb.wr("<DIV>A_id:</DIV><DIV><INPUT     TYPE=TEXT NAME=a_id     VALUE='%s'></DIV>"%(data['data']['a_id']))
 aWeb.wr("<DIV>PTR_id:</DIV><DIV><INPUT   TYPE=TEXT NAME=ptr_id   VALUE='%s'></DIV>"%(data['data']['ptr_id']))
 aWeb.wr("<DIV>Hostname:</DIV><DIV><INPUT TYPE=TEXT NAME=hostname VALUE='%s'></DIV>"%(data['data']['hostname']))
