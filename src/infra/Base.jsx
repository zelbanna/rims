...
export class ListBase extends Component {
 ...
 render(){
   ...
   <section id='div_content_left' className='content-left'><ContentList key={this.base+'_content_list'} base={this.base} header={this.header} thead={this.thead} trows={this.state.data} listItem={this.listItem} result={this.state.result} buttons=<Fragment key={this.base+'_buttons'}>{this.buttons}</Fragment>/></section>
...
export class ReportBase extends Component {
 ...
 render(){
  return <ContentReport articleClass={'report'} key={this.base+'_content_report'} base={this.base} header={this.header} thead={this.thead} trows={this.state.data} listItem={this.listItem} result={this.state.result} buttons=<Fragment key={this.base+'_buttons'}>{this.buttons}</Fragment> />
 }
}
